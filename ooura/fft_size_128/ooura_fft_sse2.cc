...
//       _mm_storel_epi64(
//           (__m128i*)&a[j0 + 40],
//           _mm_shuffle_epi32(_mm_castps_si128(xx12), _MM_SHUFFLE(3, 2, 3,
//           2)));

//       _mm_storel_epi64((__m128i*)&a[j0 + 24], _mm_castps_si128(xx22));
//       _mm_storel_epi64(
//           (__m128i*)&a[j0 + 56],
//           _mm_shuffle_epi32(_mm_castps_si128(xx22), _MM_SHUFFLE(3, 2, 3,
//           2)));
//     }
//   }
// }
...
//   //    Note: commented number are indexes for the first iteration of the
//   loop. for (j1 = 1, j2 = 2; j2 + 7 < 64; j1 += 4, j2 += 8) {
//     // Load 'wk'.
//     const __m128 c_j1 = _mm_loadu_ps(&c[j1]);       //  1,  2,  3,  4,
//     const __m128 c_k1 = _mm_loadu_ps(&c[29 - j1]);  // 28, 29, 30, 31,
//     const __m128 wkrt = _mm_sub_ps(mm_half, c_k1);  // 28, 29, 30, 31,
//     const __m128 wkr_ =
//         _mm_shuffle_ps(wkrt, wkrt, _MM_SHUFFLE(0, 1, 2, 3));  // 31, 30, 29,
//         28,
//     const __m128 wki_ = c_j1;                                 //  1,  2,  3,
//     4,
//     // Load and shuffle 'a'.
